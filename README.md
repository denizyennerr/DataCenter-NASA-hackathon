...
- By combining **NASA Earth Observation data** with urban and socioeconomic datasets, URBIAS generates an interactive, data-driven decision map that supports evidence-based urban planning.
